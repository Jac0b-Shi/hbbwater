...
class Sensor(BusinessBase):
    ...
    threshold_status = Column(String(32), nullable=True)
    threshold_source = Column(String(100), nullable=True)
    threshold_version = Column(String(50), nullable=True)
    threshold_updated_at = Column(DateTime, nullable=True)
    threshold_note = Column(Text, nullable=True)
...
class ForecastPredictionResult(BusinessBase):
    ...
    station_id = Column(String(50), nullable=True, index=True)
    actual_station_id = Column(String(50), nullable=True, index=True)
    forecast_station_id = Column(String(50), nullable=True, index=True)
    rain_source_degraded = Column(Boolean, default=False)
    degraded_reason = Column(String(100), nullable=True)
    data_status = Column(String(20), nullable=False, default="available")
    risk_level = Column(String(20), nullable=False, default="normal")
    model_risk = Column(String(20), nullable=True)
    policy_floor = Column(String(20), nullable=True)
    effective_risk = Column(String(20), nullable=True)
    policy_reason = Column(String(100), nullable=True)
    can_auto_resolve = Column(Boolean, default=False)
    risk_no_pump = Column(String(20), nullable=True)
    risk_q2_scenario = Column(String(20), nullable=True)
    scenario_pump_count = Column(Integer, nullable=True)
    pump_assumption = Column(String(50), nullable=True)
    ...
    model_version = Column(String(64), nullable=False, default="heuristic_pressure_v1")
    created_at = Column(DateTime, default=datetime.utcnow)
