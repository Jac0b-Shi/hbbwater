...
CREATE TABLE IF NOT EXISTS sensors (
    ...
    threshold_status VARCHAR(32) DEFAULT NULL COMMENT '阈值状态: provisional/empirical/surveyed/approved',
    threshold_source VARCHAR(100) DEFAULT NULL COMMENT '阈值来源',
    threshold_version VARCHAR(50) DEFAULT NULL COMMENT '阈值版本',
    threshold_updated_at TIMESTAMP NULL DEFAULT NULL COMMENT '阈值更新时间',
    threshold_note TEXT COMMENT '阈值备注',
